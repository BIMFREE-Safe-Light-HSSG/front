      ...
      <div className="relative z-10 w-full max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-[70vh]">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <Link
              href="/viewer/demo"
              className="flex h-14 items-center justify-center rounded-[1.5rem] border border-red-900/20 bg-white/40 font-mono text-[10px] uppercase tracking-[0.35em] text-red-900 transition-colors hover:bg-white/70"
            >
              로컬 3D Scene Graph 데모
            </Link>
          </div>
        </div>
      </div>
